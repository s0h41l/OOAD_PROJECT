...
namespace Semester4OOAD_Project
{
    public partial class updateClient : Form
    {
        ...
        {
            textBoxName.Text = loginSessionClient.session.Name;
            textBoxNumber.Text = loginSessionClient.session.Mobile;
            textBoxAdress.Text = loginSessionClient.session.Adress;
            ...
            gMapControl1.Position = new GMap.NET.PointLatLng(loginSessionClient.session.Longitude, loginSessionClient.session.Latitude);
        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            ...
            ser.update_client(loginSessionClient.session.Email, textBoxName.Text, textBoxPassword.Text, textBoxNumber.Text, textBoxAdress.Text, dropDrownSecretQ.selectedValue, textBoxSec.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ser.set_client_location(loginSessionClient.session.Email, longitude, latitude);
        }
